...
export const fr: Translation = {
  ...
  home: {
    ...
    finalCta: {
      ...
      text: 'Faites aujourd’hui un pas tout simple, pour avoir l’esprit plus tranquille. Sans compte, et rien ne quitte votre appareil.',
  ...
  learn: {
    ...
    mythsWallTitle: '30 mythes courants sur le cancer du sein 🔍',
