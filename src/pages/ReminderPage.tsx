...
import { interpolate } from '@/hooks/useLanguage';
        ...
        <div className="rounded-[2rem] border border-white/70 bg-card/85 p-6 shadow-petal-xl">
          {!active ? (
            ...
            <div className="text-center" dir={dir}>
              ...
              <p className="mt-3 text-lg font-black leading-8 text-primary-800">
                {interpolate(t.reminder.recurringMessage, { day })}
              </p>
              ...
              {USE_MOCK && (
                <p className="mt-3 text-sm font-semibold leading-6 text-muted">{t.reminder.demoNote}</p>
              )}
